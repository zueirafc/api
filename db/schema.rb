...
ActiveRecord::Schema.define(version: 20_160_411_143_452) do
  ...
  add_index 'post_references', %w(referenceable_id referenceable_type), name: 'idx_post_references_as_polimorphic_referenceable', using: :btree
  ...
  add_index 'targets', %w(targetable_type targetable_id), name: 'index_targets_on_targetable_type_and_targetable_id', using: :btree
  ...
  add_index 'trollers', %w(trollerable_type trollerable_id), name: 'index_trollers_on_trollerable_type_and_trollerable_id', using: :btree
